...
if __name__=="__main":
    access_token='Bearer 56213164-a6d6-4a3b-ad2c-c6dc77147e23'
    ...
    for row in data:
        ...
        runStatus = (response.json()['data'][0]['runStatus'])

        if runStatus != "running":
            row_list = [appName, tel_num, runStatus, start_time, end_time]
