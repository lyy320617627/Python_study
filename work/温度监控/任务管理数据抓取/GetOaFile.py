...
class GetFile:
    ...
    def getInstanceCount(self):
        ...
        data = {
            ...
            "formUuid": "FORM-F90BCC9989B841CFA28D49BF0303685BCMMD"
        }
                ...
                for data in dataList:
                    ...
                    if createTime:
                        ...
                        if createTime_dt == maxTime:
                            tempData = [
                                formData.get(self.labelDict.get("产品")),
                                formData.get(self.labelDict.get("送检量")),
                                formData.get(self.labelDict.get("完成量")),
                                formData.get(self.labelDict.get("在测量")),
                                formData.get(self.labelDict.get("任务预警量")),
                            ]
